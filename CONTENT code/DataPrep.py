...
# Leveraged the code from the original author: https://github.com/danicaxiao/CONTENT/blob/master/util.py
...
def retrieve_data(print_out=False):
    # Retrieve data if not in an active directory
...
# Leveraged the code from the original author: https://github.com/danicaxiao/CONTENT/blob/master/transform.py
